...
void NetworkingInstance::restartHostInstance()
{
	//Delete last thread
	printf("Preparing to restart server...\n");
	...
	printf("Old RakNetPeer dead.\n");

	//Clean up needed members
	mPeer = NULL;

	//Host info members
	mCurrentClientNum = 0;

	mPlayerOneSpeed = 100.0f;
	mPlayerTwoSpeed = 100.0f;

	mResetPlayerOneAttackTimer = false;
	mResetPlayerTwoAttackTimer = false;

	strcpy(mServerIP, "");

	printf("Old Members cleared.\n");
	...
	printf("New Raknet Peer connected.\n");
